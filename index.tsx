...
// Defensively check for import.meta.env, which might not be defined in all execution environments.
const env: Partial<ImportMetaEnv> = (typeof import.meta !== 'undefined' && import.meta.env) ? import.meta.env : {};
